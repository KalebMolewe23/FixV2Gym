                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header border-0 flex-wrap">
                                    <h4 class="fs-20 font-w700 mb-2">Informasi Trainer</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div style="margin-top:10px" class="row">
                                        <div class="col">
                                            ...
                                            <select id="country" class="form-control" name="idcountry">
                                        ...
                                        <div class="col">
                                            ...
                                            <select id="state" name="idstate" class="form-control" disabled>
                                    ...
                                    <div style="margin-top:10px" class="row">
                                        <div class="col">
                                            ...
                                            <select id="city" name="idcities" class="form-control" disabled>
...
<script>
    ...
    // Fungsi untuk membuka dialog unggah berkas
    function openFileUpload() {
        fileInput.click(); // Membuka dialog unggah file
    }
    ...
    function previewFile() {
        ...
        if (file) {
            ...
            // Jika file berupa gambar, tampilkan sebagai pratinjau
            reader.onload = function (e) {
                ...
                saveFileButton.style.display = 'block'; // Tampilkan tombol simpan
            };
    ...
    function saveFile() {
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                document.getElementById('uploadedFileInput').value = e.target.result;
                ...
                saveFileButton.style.display = 'none'; // Sembunyikan tombol simpan
            };
            ...
            Swal.fire({
                ...
                html: `
                    <div style="text-align: left;">
                        ...
                        <p><b>Nama Lengkap:</b> ${fullName || 'Tidak diisi'}</p>
